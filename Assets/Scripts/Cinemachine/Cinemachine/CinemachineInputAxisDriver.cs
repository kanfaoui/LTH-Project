...
namespace Cinemachine
{
	...
	public struct CinemachineInputAxisDriver
	{
		...
		{
			AxisBase axisBase = default(AxisBase);
			axisBase.m_Value = axis.Value;
			axisBase.m_MinValue = axis.m_MinValue;
			axisBase.m_MaxValue = axis.m_MaxValue;
			axisBase.m_Wrap = axis.m_Wrap;
			AxisBase axis2 = axisBase;
