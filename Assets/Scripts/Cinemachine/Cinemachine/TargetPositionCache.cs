	...
	internal class TargetPositionCache
	{
		...
		private class CacheCurve
		{
			public struct Item
			{
				...
				{
					Item result = default(Item);
					result.Pos = Vector3.LerpUnclamped(a.Pos, b.Pos, t);
					result.Rot = Quaternion.SlerpUnclamped(a.Rot, b.Rot, t);
					return result;
				}
			}
		...
		public struct TimeRange
		{
			...
			public static TimeRange Empty
			{
				get
				{
					...
					result.Start = float.MaxValue;
					result.End = float.MinValue;
					return result;
				}
			}
		...
		public static bool IsEmpty
		{
			get
			{
				return CacheTimeRange.IsEmpty;
			}
		}

		public static TimeRange CacheTimeRange
		{
			get
			{
				return m_CacheTimeRange;
			}
		}
		...
		public static bool HasCurrentTime
		{
			get
			{
				return m_CacheTimeRange.Contains(CurrentTime);
			}
		}
		...
		public static Vector3 GetTargetPosition(Transform target)
		{
			...
			CacheEntry value;
			if (!m_Cache.TryGetValue(target, out value))
			{
